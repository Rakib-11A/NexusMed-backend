...
const createDoctorZodSchema = z.object({
    ...
    doctor: z.object({
        ...
        contactNumber: z.string("Contact number is required.").min(11, "Contact number must be at least 11 characters").max(14, "Contact number must be at most 14 characters."),
        ...
        experience: z.int("Experience must be integer").nonnegative("Experience connot be negative.").optional(),
        ...
        currentWorkingPlace: z.string("Current working place is required.").min(2, "Current working place must be at least 2 characters.").max(50, "Current working place at most 50 characters."),
        designation: z.string("Designation is required").min(2, "Designation must be at least 2 characters").max(50, "Designation must be at most 50 character.")
    }),
